 ...
 * 
 * This component renders a styled button for Google authentication
  ...
  return (
    <Button
      ...
      className={`w-full relative group transition-all duration-300 ease-out ${
        variant === "outline" 
          ? "border border-[#603BDA]/20 hover:border-[#603BDA]/40 hover:bg-[#603BDA]/5" 
          : "hover:shadow-lg hover:shadow-[#603BDA]/20"
      } ${className}`}
      size="lg"
    >
